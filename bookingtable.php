...
<center>
    ...
    { 
        ...
        $sql = "SELECT r.bookingid, r.firstname, r.lastname, r.phone, r1.location,  r.departuredate ,r1.time, r1.name, r1.vehicleno FROM  travelbooking r,  driverdetail r1 where r.location=r1.location and r1.departuredate=r.departuredate";
