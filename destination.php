...
<body>
    ...
    <div id="search-bar" >
            <form class="example" action="searchedpackages.php" style="margin:auto;max-width:300px">
                <input type="text" placeholder="Find Trip of Your Choice...." name="search2">
                <button type="submit"><i class="fa fa-search"></i></button>
            </form>
    </div>
    <div class=" trip-collection" >
    <div id="band" class="container text-center">
        <h3>Our Packages</h3>
            ...
            <div class="row">
                <div class="column">
                    <div class="trips">
                        <img src="Images/bhaktapur durbar.jpg" alt="">
                        <div class="tripsdetail">
                            <h3>Kathmandu Valley Tour</h3>
                            <p>This valley hosts a UNESCO World Heritage Site with seven preserved locations: the centers of the three primary cities, Kathmandu Hanuman Dhoka, Patan Durbar Square and Bhaktapur Durbar Square, the two most important Buddhist stupas, Swayambhunath and Boudhanath and two famous Hindu shrines, Pashupatinath temple and ..<a href="login/index.php" class="btn btn-primary">Book Now</a></p>
                ...
                <div class="column">
                    <div class="trips">
                        <img src="Images/anan.jpg" alt="">
                        <div class="tripsdetail">
                            <h3>Annapurna Base Camp</h3>
                            <p>At Earth's Edge, we give all of our expeditions a difficulty level rating. Annapurna Base Camp is rated a Level 3, which means you can expect… “An average of 4 to 6 hours per day at altitudes not usually exceeding 4,500 metres. Some days may be up to 7 to 8 hours long but that is not typical...<a href="login/index.php" class="btn btn-primary">Book Now</a></p>
                ...
                <div class="column">
                    <div class="trips">
                        ...
                        <div class="tripsdetail">
                            ...
                            <p>Everest Base Camp Trek follows the historic route to the base of the world's tallest mountain, Everest, and offers explorers unrivaled views of beautiful forests, Sherpa villages, glacial moraines, and foothills that surround the area. It is without a doubt the grandest walk in the land of the Himalayas... <a href="login/index.php" class="btn btn-primary">Book Now</a></p>
